 ...
 */
public class FixedCollocations extends DefaultHandler {
  ...
  public void initParser () {
    ...
    static public void main (String[] args) {
        ...
        String pos = args[2]; //noun, verb, adjective
        FixedCollocations parser = new FixedCollocations();
        parser.readLuFile(luFilePath, wordListPath, pos);
    }

    public void readLuFile (String filePath, String WordListPath, String pos) {
        try {
            ArrayList<String> wordList = vu.cornetto.util.FileProcessor.ReadFileToArrayList(WordListPath);
            FileOutputStream fos = new FileOutputStream(filePath+".fixed."+pos+".xml");
                        ...
                        try {
                            ...
                            if (doc!=null) {
                                ...
                                if (node.getNodeName().equals("cdb_lu")) {
                                    ...
                                    if ((theForm.length()>0) &&
                                        (thePos.equals(pos))) {
                                        if (wordList.contains(theForm)) {
                                            //System.out.println("theForm = " + theForm);
                                            getFixedCollocations(node, fos);
                                        }
                                    }
                                    else {
    ...
    public void getFixedCollocations(Node node, FileOutputStream fos)
    ...
    public String getCollecationXml(Node node) {
        ...
        String str = "<collocation fixed=\""+"true"+"\" type=\""+getSynSubtype(node)+"\">\n";
